...
module UniIS.Targets.Mips32
  ( theTM
  , tmFancyMips32
  )
where

import UniIS.Targets.Generic
...
mkSimpleNBitRegMBitImmCompInst
  ...
  -> Instruction
mkSimpleNBitRegMBitImmCompInst parts op r1 r3 imm n m =
...
mkSimpleNBitRegMBitFirstImmCompInst
  ...
  -> Natural
     -- ^ The number of bits of the immediate.
  -> Instruction
mkSimpleNBitRegMBitFirstImmCompInst parts op r2 r3 imm n m =
  let dtN = mkIntTempType n
      dtM = mkIntConstType imm m
