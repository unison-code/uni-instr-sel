...
if.end:                                           ; preds = %entry
  ...
  br i1 %cmp4, label %return, label %if.end7, !exec_freq !2

if.end7:                                          ; preds = %if.end
  %cmp8 = icmp slt i32 %n, 0
  %conv11 = sext i16 %a to i32
  br i1 %cmp8, label %if.then10, label %if.end14, !exec_freq !3
...
if.end14:                                         ; preds = %if.end7
  %shr = ashr i32 %conv11, %n
  %conv16 = trunc i32 %shr to i16
  br label %return, !exec_freq !5

return:                                           ; preds = %if.end14, %if.then10, %if.end, %if.then
  %retval.0 = phi i16 [ %sub, %if.then ], [ %conv13, %if.then10 ], [ %conv16, %if.end14 ], [ 0, %if.end ]
