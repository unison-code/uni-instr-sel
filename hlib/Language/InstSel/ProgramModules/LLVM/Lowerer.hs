...
--
-- Lowers an LLVM AST module by converting high-level instructions such as
-- 'switch' and 'getelementptr' into multiple lower-level LLVM IR instructions.
--------------------------------------------------------------------------------
...
lowerBB
  acc
  (BasicBlock label insts (Do (Switch operand def_label dests _)))
  =
