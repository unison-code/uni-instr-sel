...
import qualified Language.InstSel.OperationStructures as OS
import qualified Language.InstSel.OpTypes as Op
import qualified Language.InstSel.Patterns.Base as P
import qualified Language.InstSel.Patterns.LLVM.Base as LLVM
