...
import qualified Language.InstrSel.OperationStructures as OS
import qualified Language.InstrSel.OpTypes as Op
import qualified Language.InstrSel.Patterns.Base as P
import qualified Language.InstrSel.Patterns.LLVM.Base as LLVM
import Language.InstrSel.DataTypes
import Language.InstrSel.PrettyPrint
  ...
  extend t (LLVM.RegRangeStmtExpr val (Range lo up)) =
    let t1 = extend t val
        ...
        t3 = addNewNodeWithNI t2 (G.NodeInfo (G.NTBinaryOp shift_op)
                                  (currentLabel t2) (prettyShow shift_op))
...
insertMaskNodesForRegRange t lo up =
  let t1 = extend t up
      ...
      t3 = addNewNodeWithNI t2 (G.NodeInfo (G.NTBinaryOp op1)
                                (currentLabel t2) (prettyShow op1))
      ...
      t11 = addNewNodeWithNI t10 (G.NodeInfo (G.NTBinaryOp op3)
                                  (currentLabel t10) (prettyShow op3))
      ...
      t15 = addNewNodeWithNI t14 (G.NodeInfo (G.NTBinaryOp op4)
                                  (currentLabel t14) (prettyShow op4))
